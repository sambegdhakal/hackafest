...
prompt  APPLICATION 109 - CC_MEMBERS
--
-- Application Export:
--   Application:     109
--   Name:            CC_MEMBERS
--   Date and Time:   20:46 Saturday November 28, 2020
--   Exported By:     SAMBEG1
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4789730209041155));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'SAMBEG1'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'CC_MEMBERS'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F109'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 4842125257230992 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 4841701939230992 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 4844823901230994 + wwv_flow_api.g_id_offset,
  p_error_template=> 4841128026230991 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20201128203649',
  ...
  p_cust_authentication_process=> '.'||to_char(4850425935231004 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 21,
  p_default_label_template => 4849124170230999 + wwv_flow_api.g_id_offset,
  p_default_report_template => 4848427623230998 + wwv_flow_api.g_id_offset,
  p_default_list_template => 4847425194230997 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 4849413381230999 + wwv_flow_api.g_id_offset,
  p_default_button_template => 4842229816230992 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 4843832644230994 + wwv_flow_api.g_id_offset,
  p_default_form_template => 4843906068230994 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 4845727628230995 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 4844823901230994 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>4844823901230994 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 4843326109230994 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 4843721967230994 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 4844420950230994 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'SAMBEG1',
  p_last_upd_yyyymmddhh24miss=> '20201128203649',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 4850711927231004 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 4853308179237190 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_tab (
  p_id=> 4852305382231011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_PAGE_1',
...
--application/shared_components/navigation/tabs/parent/t_page_1
wwv_flow_api.create_toplevel_tab (
  p_id=> 4852404876231011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'main',
  p_tab_sequence=> 10,
  p_tab_name  => 'T_PAGE 1',
  p_tab_text  => 'Page 1',
  p_tab_target=> 'f?p=109:1:&SESSION.',
...
wwv_flow_api.create_page_plug (
  p_id=> 4852510162231012 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'cc_reason_analysis',
  p_region_name=>'',
  p_plug_template=> 4843832644230994+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5(
  p_id => 4852610338231012+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1,
  p_region_id => 4852510162231012+wwv_flow_api.g_id_offset,
  p_default_chart_type     =>'Horizontal2DColumn',
  p_chart_title            =>'CC_REASONS',
  p_chart_name             =>'chart_4852610338231012',
  p_chart_width            =>700,
  p_chart_height           =>500,
  p_chart_animation        =>'Appear',
  p_display_attr           =>':H:N:V:::::V:Y:None:::N:::Default',
  p_dial_tick_attr         =>':::::::::::',
...
'reasons LABEL, '||chr(10)||
'cc_mem VALUE'||chr(10)||
'FROM('||chr(10)||
'SELECT '||chr(10)||
'CASE WHEN b.firstname||b.lastname||b.gender  IS NOT NULL AND Length(a.memid)<>3 THEN ''MEMID received from claims is not of standard length (demographic mathces)'''||chr(10)||
'WHEN b.firstname||b.lastname||b.gender  IS NOT NULL AND Length(b.memid)<>3 THEN ''MEMID received from eligibilities is not of standard length (demographic matches)'''||chr(10)||
'WHEN b.first';

a1:=a1||'name||b.lastname||b.gender  IS NOT NULL AND Length(a.memid)=3 AND Length(b.memid)=3 THEN ''Demographic matches'''||chr(10)||
'WHEN b.firstname||b.lastname||b.gender  IS NULL AND c.firstname||c.lastname||c.gender  IS NULL THEN ''Memid is not seen from overall elig'''||chr(10)||
'WHEN b.firstname||b.lastname||b.gender  IS  NULL AND c.firstname||c.lastname||c.gender  IS  NOT NULL THEN ''Memid is not seen from active elig only''  EN';

a1:=a1||'D AS reasons,'||chr(10)||
'Count(DISTINCT a.memid) AS cc_mem'||chr(10)||
'FROM zzz_cc_members a'||chr(10)||
'left JOIN'||chr(10)||
'vh_elig_sam_active b'||chr(10)||
'ON a.firstname||a.lastname||a.gender=b.firstname||b.lastname||b.gender '||chr(10)||
'left JOIN'||chr(10)||
'vh_elig_sam c'||chr(10)||
'ON a.firstname||a.lastname||a.gender=c.firstname||c.lastname||c.gender'||chr(10)||
'GROUP BY CASE WHEN b.firstname||b.lastname||b.gender  IS NOT NULL AND Length(a.memid)<>3 THEN ''MEMID received from claims is not of ';

a1:=a1||'standard length (demographic mathces)'''||chr(10)||
'WHEN b.firstname||b.lastname||b.gender  IS NOT NULL AND Length(b.memid)<>3 THEN ''MEMID received from eligibilities is not of standard length (demographic matches)'''||chr(10)||
'WHEN b.firstname||b.lastname||b.gender  IS NOT NULL AND Length(a.memid)=3 AND Length(b.memid)=3 THEN ''Demographic matches'''||chr(10)||
'WHEN b.firstname||b.lastname||b.gender  IS NULL AND c.firstname||c.lastnam';

a1:=a1||'e||c.gender  IS NULL THEN ''Memid is not seen from overall elig'''||chr(10)||
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 4852710994231013+wwv_flow_api.g_id_offset,
  p_chart_id => 4852610338231012+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4852916874231015 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 4843326109230994+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(4851802338231009 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 4849413381230999+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_plug (
  p_id=> 4854130090300256 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Groupwise_cc ',
  p_region_name=>'',
  p_plug_template=> 4843832644230994+ wwv_flow_api.g_id_offset,
...
a1 := null;
wwv_flow_api.create_flash_chart5(
  p_id => 4854323382300262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1,
  p_region_id => 4854130090300256+wwv_flow_api.g_id_offset,
  p_default_chart_type     =>'2DColumn',
  p_chart_title            =>'groupwise_cc',
  p_chart_name             =>'chart_4854323382300262',
  p_chart_width            =>700,
  p_chart_height           =>500,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT  NULL LINK, group1 LABEL, cc_ct Value'||chr(10)||
'FROM'||chr(10)||
'('||chr(10)||
'SELECT a.group1, Count(DISTINCT a.memid) cc_ct FROM zzz_cc_members a'||chr(10)||
'GROUP BY a.group1)'||chr(10)||
'';

wwv_flow_api.create_flash_chart5_series(
  p_id => 4854414116300263+wwv_flow_api.g_id_offset,
  p_chart_id => 4854323382300262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
  p_series_name               =>'Series 1',
  p_series_query              => a1,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT group1,memid, firstname,lastname,gender,salary FROM '||chr(10)||
'zzz_cc_members';

wwv_flow_api.create_page_plug (
  p_id=> 4854617331318257 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'cc_members_with_group',
  p_region_name=>'',
  p_plug_template=> 4844420950230994+ wwv_flow_api.g_id_offset,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT group1,memid, firstname,lastname,gender,salary FROM '||chr(10)||
'zzz_cc_members';

wwv_flow_api.create_worksheet(
  p_id=> 4854701374318257+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_region_id=> 4854617331318257+wwv_flow_api.g_id_offset,
  p_name=> 'cc_members_with_group',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 4854932619318261+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'GROUP1',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Group1',
  p_report_label           =>'Group1',
  p_sync_form_label        =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4855027145318262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'MEMID',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Memid',
  p_report_label           =>'Memid',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4855104202318262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4855203531318262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4855332550318262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4855405363318262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'GROUP1:MEMID:FIRSTNAME:LASTNAME:GENDER:SALARY';

wwv_flow_api.create_worksheet_rpt(
  p_id => 4855527582318493+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 4854701374318257+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_item(
  p_id=>4857628106356464 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'ACTIVE_ELIG',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 4854130090300256+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> '',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'ACTIVE_ELIG',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4857800485356464 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'CC_LIST_WITH_GROUP',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
...
begin
p:=p||'begin'||chr(10)||
'proc_create_active_tbl;'||chr(10)||
'end;'||chr(10)||
'commit;';

wwv_flow_api.create_page_process(
  p_id     => 4857903003387046 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Create_active_elig',
  p_process_sql_clob => p, 
  p_process_error_message=> 'active table not created',
  p_process_success_message=> 'active table created',
...
wwv_flow_api.create_page_process(
  p_id     => 4858126337403304 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 1,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'CC_MEMBER_TABLE',
  p_process_sql_clob => p, 
  p_process_error_message=> 'cc_list creation failed',
  p_process_success_message=> 'cc_list created',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
null;
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 4840717371230989 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20201128200210'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4851028552231007 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_plug_template=> 4843906068230994+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4851129475231008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 4851028552231007+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> '',
  p_prompt=>'Username',
  ...
  p_field_template=> 4849124170230999+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4851208442231008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4851329682231008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(4842229816230992 + wwv_flow_api.g_id_offset),
  p_begin_on_new_line=> 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan=> 1,
  p_rowspan=> 1,
...
wwv_flow_api.create_page_process(
  p_id     => 4851500073231009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 4851414746231009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 4851705073231009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4851610028231009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 4851802338231009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>4852828756231014 + wwv_flow_api.g_id_offset,
  p_menu_id=>4851802338231009 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Page 1',
  p_long_name=>'',
  p_link=>'f?p=109:1:&SESSION.',
  p_page_id=>1,
...
prompt  ......Page template 4840717371230989
...
wwv_flow_api.create_template(
  p_id=> 4840717371230989 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 4840811005230990
...
wwv_flow_api.create_template(
  p_id=> 4840811005230990 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 